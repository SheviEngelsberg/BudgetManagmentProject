...
from BudgetManagmentProject.app.db import db_functions
from BudgetManagmentProject.app.models.user import User
...
async def create_user(new_user: User):
    ...
    try:
        ...
        return await db_functions.add_user(user, collection_name="users")
    except Exception as e:
